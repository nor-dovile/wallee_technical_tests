...
Expected Result: The user is redirected to the cart page, and the cart's contents are displayed correctly.
...
Expected Result: The user is redirected to the My Account page, and the login option is displayed.
...
Expected Result: The product's quantity increases in the cart.
...
Expected Result: The quantity and "Total" price per product are updated accordingly (increasing/decreasing), and the "Total" and "Subtotal" prices are updated accordingly as well (increasing/decreasing).
...
Test Steps:
 ...
 Expected Result: The cart displays a message "Your cart is currently empty!" indicating it is empty, and when clicking on the "Start Shopping" button the user is redirected to the homepage.
...
Expected Result: The cart icon/indicator correctly shows the number of items added to the cart.
...
Expected Result: The added products stay in the cart even after the page reloading.
...
Expected Result: The error code appears: “Coupon … does not exist!” and the discount is not applied to the total sum of the order until the user enters the valid coupon code.
...
Expected Result: An appropriate error message is displayed like "The provided IBAN is not accepted. ", and the user cannot complete the checkout.
...
Expected Result: The user can cancel the payment, he is redirected to the Checkout page with his order, and the message: "The payment is canceled as requested" is displayed.
...
Expected Result: After canceling the order, the user is redirected to the Checkout page with his order information, and the message appears: "The payment is canceled as requested". 
...
Expected Result: An order confirmation email is received, well-formatted, and contains all relevant order details (order number, items, prices, billing, and shipping addresses).
...
Expected Result: The items stay in the cart and any entered checkout information persists, allowing the user to complete the checkout without re-entering details.
...
Expected Result: The account is created successfully, the order is placed, and the user receives an order confirmation email. The user can log in with the created account credentials. He also can see all the information on his "My Account" page.
...
Expected Result: An appropriate error message is displayed: "Please enter a valid email address", and the user cannot proceed until a valid email address is entered.
...
Expected Result: An error message is displayed: "An account is already registered with your email address. Please log in before proceeding.", indicating that the email is already in use, and the user is suggested to log in instead.
...
Expected Result: The user receives an account creation confirmation email with details on how to log in and manage his account.
...
Expected Result: The new order appears in the order history with the correct order details.
...
Expected Result: The user can log in successfully with the created account credentials and access his account dashboard.
...
Expected Result: The user is not able to connect to his account and the error message appears: "Error: The password you entered for the email address ... is incorrect. Lost your password?"
...
Expected Result: After clicking the "Lost your password?" link, the user gets a successful message on the screen: "Password reset email has been sent." when he fills up his email address. When the user checks his email, he gets a magic link, where he can change his password and log in afterwards.
...
Expected Result: The user is redirected to the orders page where he can see the history of his orders.
...
Expected Result: The user is redirected to the subscriptions page where he can see subscriptions and browse for new ones if he has no subscriptions yet.
...
Expected Result: The user is redirected to the downloads page where he can see his downloads and browse for more.
...
Expected Result: The user is redirected to the coupons page where he can see all his coupons.
...
Expected Result: the user can change the address and gets a success message: "Address changed successfully".
...
Expected Result: The user is redirected to the Account details page where he can edit his data.
...
Expected Result: The user is allowed to save a new strong password.
...
Expected Result: The user is not allowed to save the new password, the error message appears: "Weak - Please enter a stronger password.
...
Expected Result: The user is redirected to the log-out page where he can disconnect from the website.


## All the menu items are functional

Test Case ID: TC-HOMEPAGE-01
Test Case Title: Verify Demo Shop Item
...
Test Steps:
    1. Visit website homepage: https://woocommerce.showcase-wallee.com/
    2. Click on the "Demo Shop" navigation menu item.
...
Test Case Title: Verify Shop Menu Item
...
Test Steps:
    1. Visit website homepage: https://woocommerce.showcase-wallee.com/
    2. Click on the "Shop" navigation menu item.

Expected Result: The user is redirected to the shop page, displaying all products without errors.



Test Case ID: TC-HOMEPAGE-03
Test Case Title: Verify Cart Menu Item
...
Test Steps:
    1. Visit website homepage: https://woocommerce.showcase-wallee.com/
    2. Click on the "Cart" navigation menu item.

Expected Result: The user is redirected to the cart page, showing the cart contents without errors.



Test Case ID: TC-HOMEPAGE-04
Test Case Title: Verify Cart Menu Icon Item
...
Test Steps:
    1. Visit website homepage: https://woocommerce.showcase-wallee.com/
    2. Click on the "Cart" item on the top right of the page.

Expected Result: The user is redirected to the cart page, showing the cart contents without errors.



Test Case ID: TC-HOMEPAGE-05
Test Case Title: Verify Checkout Menu Item
...
Test Steps:
    1. Visit website homepage: https://woocommerce.showcase-wallee.com/
    2. Click on the "Checkout" navigation menu item.

Expected Result: The user is redirected to the checkout page, and the page loads without errors.



Test Case ID: TC-HOMEPAGE-06
Test Case Title: Verify My Account Menu Item
...
Test Steps:
    1. Visit website homepage: https://woocommerce.showcase-wallee.com/
    2. Click on the "My Account" navigation menu item.
...
Test Case ID: TC-HOMEPAGE-07
Test Case Title: Verify Footer Menu Items
...
Expected Result: Each footer menu item redirects to the corresponding page (e.g., Demo Shop, WordPress) without errors.
